...
<?php foreach($details as $d) {}?>
  ...
  <div class="container-fluid">
	   ...
	   <?php echo $this->session->flashdata('msg');  ?>
							   <form class="form-material form-horizontal" role="form" action="<?php echo site_url('Admin/edit_testimony/'.$id); ?>" method="post">
 ...
 <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <textarea class="form-control" id="testimony" placeholder="" name="testimony" ><?php echo $d->testimony ?></textarea>
                </div>
