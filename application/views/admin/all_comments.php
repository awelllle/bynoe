  ...
  <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                            <h3 class="box-title m-b-0">Comments</h3>
                            <p class="text-muted m-b-30">All Comments</p>
                                            ...
                                            <td><?php echo $c->name; ?></td>
											 <td><?php echo $c->email; ?></td>
											  <td><?php echo $c->comment; ?></td>
											   ...
											   <td><?php echo $c->prop_title; ?></td>
											   <td><?php echo $c->type; ?></td>
                                            
                                            <td><?php echo date ('M d, Y',strtotime($c->timestamp)); ?></td>
